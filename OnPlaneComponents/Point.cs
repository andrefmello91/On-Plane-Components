...
namespace OnPlaneComponents
{
	...
	public struct Point : IEquatable<Point>, IComparable<Point>
	{
		...
		/// <summary>
		/// Get the angle related to horizontal axis, in radians, of a line connecting this <see cref="Point"/> to <paramref name="other"/>.
		/// </summary>
		...
		/// <para>If this <see cref="Point"/>'s Y coordinate is smaller, or Y is approximated and X is smaller, -1 is returned.</para>
		/// </remarks>
