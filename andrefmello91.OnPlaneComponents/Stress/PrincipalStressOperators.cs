...
namespace andrefmello91.OnPlaneComponents
{
	public partial struct PrincipalStressState
	{
		...
		/// </summary>
		public static bool operator ==(PrincipalStressState left, IState<Pressure>? right) => left.Equals(right);
		...
		///     = 0).
		/// </summary>
		public static StressState operator +(PrincipalStressState left, IState<Pressure>? right) =>
			right is not null
				? StressState.FromPrincipal(left) + right.ToPrincipal()
				: (StressState) left;
		...
		/// </remarks>
		public static explicit operator PrincipalStressState(StressState state) => state.ToPrincipal();
